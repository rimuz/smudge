...
namespace sm {
    ...
    */
    ...
    constexpr AlphaCharU8 chars_2_2[] = {
        #include "sm/utils/unicode/chars_2_2.inc"
    };

    constexpr AlphaCharU8 chars_2_3[] = {
        #include "sm/utils/unicode/chars_2_3.inc"
    };

    constexpr AlphaCharU8 chars_3_2[] = {
        #include "sm/utils/unicode/chars_3_2.inc"
    };

    constexpr AlphaCharU8 chars_3_3[] = {
        #include "sm/utils/unicode/chars_3_3.inc"
    };

    constexpr AlphaCharU8 chars_4_3[] = {
        #include "sm/utils/unicode/chars_4_3.inc"
    };

    constexpr AlphaCharU8 chars_4_4[] = {
        #include "sm/utils/unicode/chars_4_4.inc"
    };
